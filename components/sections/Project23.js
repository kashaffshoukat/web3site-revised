...
export default function Project23() {
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/db-labz-alley.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}} className="tf-section project2">
