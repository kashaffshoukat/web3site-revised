...
export default function Cta5() {
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/common/db-datblock-character.png')",
             backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}} className="tf-section tf_CTA">
