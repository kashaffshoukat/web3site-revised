...
export default function Partner3() {
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/db-datblock-character.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}} className="tf-section tf_partner">
