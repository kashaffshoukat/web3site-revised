...
export default function Project32() {
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/db-space-elements.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}} className="tf-section project">
