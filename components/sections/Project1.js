...
export default function Project1() {
    return (
        <section
            className="tf-section project"
            style={{
                backgroundImage: "url('/assets/images/db-sky-city-transp.png')",
                            ...
                            <div className="image-wrapper" data-aos="fade-in" data-aos-duration={1000}>
                                <div className="swiper-container slider-1">
                                    <Swiper {...swiperOptions} className="swiper-wrapper">
                                        <SwiperSlide>
                                            <img src="/assets/images/common/img_slider_1.jpg" alt="" />
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <img src="/assets/images/common/img_slider_1.jpg" alt="" />
                                        </SwiperSlide>
                            ...
                            <div className="content-wrapper">
                                <div className="content_inner" data-aos="fade-left" data-aos-duration={1200}>
                                    <div className="wrapper">
                                        ...
                                        <ul className="price">
                                            <li><span>Price: $0.4</span></li>
                                            <li><span>Total sales: $4720</span></li>
                                        </ul>
