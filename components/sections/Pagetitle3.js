...
export default function Pagetitle3() {
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/common/space2.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"} }className="page-title st3">
                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="box-slider">
                                                ...
                                                <div className="image">
                                                    <img className="img_main" src="assets/images/common/db-tech-character.png" alt="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
