...
export default function Project22() {
    ...
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/db-labz-01.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}} className="tf-section project">
