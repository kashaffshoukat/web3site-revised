export default function Threestep() {
    return (
        <section
            className="tf-section three_step"
            style={{
                backgroundImage: "url('/assets/images/common//db-labz-alley.png')",
                backgroundSize: "cover",
                backgroundPosition: "center",
                backgroundRepeat: "no-repeat",
                position: "relative", // ✅ Ensure it layers properly
                zIndex: 2,             // ✅ Make sure it stays above
            }}
        >
                        ...
                        <div className="wrap-box">
                            <div className="icon-box-style3">
                                ...
                                <div className="content">
                                    <h5 className="title">Submit KYC</h5>
                            ...
                            <div className="icon-box-style3">
                                ...
                                <div className="content">
                                    <h5 className="title">Verify Wallet</h5>
