...
export default function Faqs1() {
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/db-sky-city-transp.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}} className="tf-section FAQs">
