...
export default function Faqs2() {
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/db-space-elements.png')", 
            backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}} className="tf-section FAQs">
