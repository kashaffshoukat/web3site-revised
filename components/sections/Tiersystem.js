...
export default function Tiersystem() {
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/db-datblock-character.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}}className="tf-section tier_system">
