...
export default function Cta22() {
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/common/db-labz-01.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}} className="tf-section tf_CTA_2">
