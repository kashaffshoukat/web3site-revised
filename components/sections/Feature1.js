...
export default function Feature1() {
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/db-labz-01.png')", backgroundSize: "cover",
             backgroundPosition: "center", backgroundRepeat: "no-repeat"}} className="tf-section fueture">
