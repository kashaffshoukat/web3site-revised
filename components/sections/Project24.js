...
export default function Project24() {
    ...
    return (
        <>
            ...
            <section style={{backgroundImage: "url('/assets/images/db-datblock-character.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat"}} className="tf-section project_2">
