...
export default function ConnectWallet() {
  ...
  const [activeIndex, setActiveIndex] = useState(56);
              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="wallet-form">
                    ...
                    <p className="sub">
                      Please Choose a network &amp; select a wallet to connect
                      to this marketplace
                    </p>
                    ...
                    <div className="choose-network flat-tabs">
                      ...
                      <ul className="menu-tab">
                        <li
                          ...
                          onClick={() => handleOnClick("56")}
                        >
                          <img
                            src="/assets/images/common/wallet_1.png"
                            alt=""
                          />
                          <span>BSC</span>
                        </li>
                        ...
                        >
                          <img
                            src="/assets/images/common/wallet_2.png"
                            alt=""
                          />
                          <span>ETH</span>
                        </li>
                        ...
                        >
                          <img
                            src="/assets/images/common/wallet_3.png"
                            alt=""
                          />
                          <span>BTC</span>
                        </li>
                        ...
                        >
                          <img
                            src="/assets/images/common/wallet_4.png"
                            alt=""
                          />
                          <span>XRP</span>
                        </li> */}
                    ...
                    <div className="connect-wallet">
                      ...
                      <ul>
                        ...
                        >
                          <Link href="#">
                            <img
                              src="/assets/images/common/wallet_6.png"
                              alt=""
                            />
                        ...
                        <li>
                          <Link href="#">
                            <img
                              src="/assets/images/common/wallet_9.png"
                              alt=""
                            />
                            <span>Core</span>
                            <span className="icon">
                        ...
                        <li>
                          <Link href="#">
                            <img
                              src="/assets/images/common/wallet_10.png"
                              alt=""
                            />
                            <span>Bitski</span>
                            <span className="icon">
